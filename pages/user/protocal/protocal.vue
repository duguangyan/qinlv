<template>
	<view>
		<div class="protocal">
			<div class="center mgt-40 fs30">服务条款与协议</div>
			<div class="content">

				河南沁绿农业科技有限公司（以下简称沁绿农业）依据以下条件和条款为您提供所享有的服务，请仔细阅读并遵守。欢迎阅读沁绿农业服务条款协议（下称“本协议”）。本协议阐述之条款和条件适用于您使用上上农夫及关联产品所提供的各种工具和平台提供的所有服务。
				一、接受条款
