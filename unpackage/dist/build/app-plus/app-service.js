...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/main/search/search"],{"2a3c":function(e,t,n){"use strict";n.r(t);var r=n("eec5"),o=n("d0b8");for(var c in o)"default"!==c&&function(e){n.d(t,e,function(){return o[e]})}(c);n("68cb");var i=n("2877"),s=Object(i["a"])(o["default"],r["a"],r["b"],!1,null,"6d497e5f",null);t["default"]=s.exports},"68cb":function(e,t,n){"use strict";var r=n("dd40"),o=n.n(r);o.a},b3cc:function(e,t,n){"use strict";(function(e){n("b440"),n("921b");r(n("66fd"));var t=r(n("2a3c"));function r(e){return e&&e.__esModule?e:{default:e}}e(t.default)}).call(this,n("6e42")["createPage"])},d0b8:function(e,t,n){"use strict";n.r(t);var r=n("fafd"),o=n.n(r);for(var c in r)"default"!==c&&function(e){n.d(t,e,function(){return r[e]})}(c);t["default"]=o.a},dd40:function(e,t,n){},eec5:function(e,t,n){"use strict";var r=function(){var e=this,t=e.$createElement,r=(e._self._c,n("2a78")),o=n("5329");e.$mp.data=Object.assign({},{$root:{m0:r,m1:o}})},o=[];n.d(t,"a",function(){return r}),n.d(t,"b",function(){return o})},fafd:function(e,t,n){"use strict";(function(e,r){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o=c(n("e0d7"));function c(e){return e&&e.__esModule?e:{default:e}}var i=function(){return n.e("components/common/Dialog").then(n.bind(null,"3b86"))},s={data:function(){return{title:"确认删除所有历史记录吗?",isShow:!1,search:"",records:[],loading:!1,index:"",platform:0}},components:{Dialog:i},onLoad:function(){this.platform=e.getStorageSync("platform")},onShow:function(){this.getRecord()},methods:{doConfirm:function(){var t=this.records;1==this.index?(index=t.indexOf(item),t.splice(index,1),e.setStorageSync("records",JSON.stringify(t))):(t.splice(0,t.length),e.setStorageSync("records",JSON.stringify(t))),this.isShow=!1},doCancel:function(){this.isShow=!1},toSearch:function(t,n){if(n&&(this.search=n),!this.search)return o.default.tips("请输入搜索内容");this.setRecord(this.search),e.navigateTo({url:"/pages/order/goodsList/goodsList?search="+this.search})},getRecord:function(){var t=e.getStorageSync("records");if(t){try{t=JSON.parse(t)}catch(n){return console.log(r(n," at pages\\main\\search\\search.vue:92"))}t instanceof Array&&(this.records=t)}},setRecord:function(t){var n=this.records,r=n.indexOf(t);r>-1&&n.splice(r,1),n.unshift(t),e.setStorageSync("records",JSON.stringify(n))},delRecord:function(e,t){this.records;this.index=void 0!==t?1:2,this.isShow=!0}}};t.default=s}).call(this,n("6e42")["default"],n("0de9")["default"])}},[["b3cc","common/runtime","common/vendor"]]]);
});
